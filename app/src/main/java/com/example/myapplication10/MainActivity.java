...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonMultiply, buttonSub, buttonDivision,
            buttonPercent, buttonZero, buttonPower, buttonEqual, buttonClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSub = findViewById(R.id.sub_btn);
        buttonMultiply = findViewById(R.id.multiple_btn);
